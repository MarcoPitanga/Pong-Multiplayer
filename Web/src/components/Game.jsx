  ...
  return (
    <div className="relative">
      <SVG width={gameConfig.width} height={gameConfig.height}>
        <Rect x="0" y="0" width={gameConfig.width} height={gameConfig.height} style={{ fill: 'rgb(0, 0, 0)' }} />
        <Line
        ...
        <text x={gameConfig.width / 2 + 20} y="45" style={{ fill: 'rgba(255, 255, 255, 0.7)', fontSize: '50px' }}>
          {match.score2}
        </text>

        {ball && <Circle cx={ball.x} cy={ball.y} r={ball.width} style={{ fill: '#fff' }} />}
      </SVG>
